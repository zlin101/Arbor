...
Now apply the dual-review-correctness skill. You are the correctness reviewer. Work through the correctness checklist and security/reliability checklist against the changed scope. Return EXACTLY this YAML envelope — no prose, no questions:
