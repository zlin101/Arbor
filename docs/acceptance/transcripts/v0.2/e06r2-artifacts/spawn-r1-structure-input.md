...
Now follow the dual-review-structure skill. Review the change for structural quality — spaghetti/branch growth, abstraction quality, canonical layer and reuse, type and boundary clarity, file/component sprawl, orchestration and atomicity. Return ONLY your YAML verdict envelope exactly as defined in the dual-review-structure skill's output contract (section 8).