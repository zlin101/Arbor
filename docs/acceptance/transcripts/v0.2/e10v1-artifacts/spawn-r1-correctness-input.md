...
Now follow the dual-review-correctness skill. Review the changed scope for correctness issues. Your output must be exactly the YAML verdict envelope defined in the dual-review-correctness skill's output contract. Nothing else.