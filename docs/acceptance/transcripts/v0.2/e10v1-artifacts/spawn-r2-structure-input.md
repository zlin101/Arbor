...
Now follow the dual-review-structure skill. Review the changed scope for structural issues. Your output must be EXACTLY this YAML envelope and nothing else:
